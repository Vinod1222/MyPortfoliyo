export function SkeletonScreen() {
  return (
    ...
    >
      <header className="flex min-h-[88px] items-center justify-between border-b border-white/10">
        <div className="skeleton-shimmer relative h-8 w-52 overflow-hidden rounded-full bg-white/10" />
        ...
        <div className="skeleton-shimmer relative h-12 w-36 overflow-hidden rounded-xl bg-[#ff664d]/30" />
      </header>

      <section className="grid min-h-[calc(100vh-88px)] grid-cols-[minmax(0,0.92fr)_minmax(320px,0.9fr)] items-center gap-[5vw] max-lg:grid-cols-1">
        <div>
          <div className="skeleton-shimmer relative mb-8 h-11 w-64 overflow-hidden rounded-full bg-[#25c99c]/15" />
          <div className="skeleton-shimmer relative mb-4 h-20 w-[min(620px,100%)] overflow-hidden rounded-xl bg-white/10" />
          <div className="skeleton-shimmer relative mb-8 h-20 w-[min(460px,80%)] overflow-hidden rounded-xl bg-[#ff664d]/22" />
        ...
        <div className="relative mx-auto aspect-square w-[min(42vw,520px)] min-w-[300px] rounded-full max-md:w-[min(72vw,290px)] max-md:min-w-0">
