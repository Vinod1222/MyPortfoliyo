  ...
  return (
    ...
    >
      <div>
        ...
        <a className="mb-4 flex items-center gap-3.5 text-base font-bold text-[#34445b] [overflow-wrap:anywhere]" href="mailto:deepyadav153107@gmail.com">
          <Mail size={18} />
          deepyadav153107@gmail.com
        </a>
        <a className="mb-4 flex items-center gap-3.5 text-base font-bold text-[#34445b]" href="tel:+918542824307">
          <Phone size={18} />
          +91 8542824307
        </a>
        ...
        <div className="mt-7 flex flex-wrap gap-3.5">
          <a className="inline-flex min-h-11 items-center gap-2.5 rounded-full bg-white px-5 font-black text-[#10142a] shadow-[0_4px_14px_rgba(15,20,42,0.16)] max-[420px]:w-full max-[420px]:justify-center" href="https://github.com/" target="_blank" rel="noreferrer">
            <Github size={20} />
            GitHub
          </a>
          <a
